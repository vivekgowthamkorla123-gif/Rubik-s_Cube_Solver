...
#include <bits/stdc++.h>
#include "Model/3dArray.cpp"
#include "Model/1dArray.cpp"
...
// IDA* SOLVER ---------------------------------------------------------------------------------------------------
    ...
    // cube.print();
    //
    // // Perform a random shuffle on the cube (example: 9 random moves)
    ...
    // cube.print();
    //
    // string fileName = "C:\\Users\\chinm\\CLionProjects\\RubiksCubeSolver\\Database\\cornerDepth9V1.txt";
    //
    // IDAstarSolver<RubiksCubeBitboard, HashBitboard> idAstarSolver(cube, fileName);
    //
    // // Solve the cube using IDA* algorithm
...
//     CornerDBMaker dbMaker(fileName, 0x99);
    ...
    //
    // if (success) {
    //     std::cout << "Database created and stored successfully in " << fileName << std::endl;
    // } else {
    //     std::cout << "Failed to create and store the database." << std::endl;
    // }
